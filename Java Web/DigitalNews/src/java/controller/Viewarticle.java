...
//          Get the ID of the Article  wants to see in detail
            int id=0;
            try {
...
//          get Article detail wants to see
            request.setAttribute("currentArticle", arDAO.getArticleById(id));
//          top 5 recent Article
